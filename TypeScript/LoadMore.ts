    ...
    */
    ...
    export class LoadMore {
        ...
        private onLoadMoreClick(eventObject: Event) {
            ...
            let generateRequestUrl = `https://cors-anywhere.herokuapp.com/api.reddit.com/r/${this.commentThread.threadInformation.subreddit}/comments/${this.commentThread.threadInformation.id}/z/${this.data.id}.json`;
